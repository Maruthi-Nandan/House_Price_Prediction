...
class BivariateAnalysisStrategy(ABC):
    @abstractmethod
    def analyzer(self, df: pd.DataFrame, feature1: str, feature2: str):
        """
...
class CategoricalVsNumericalAnalysis(BivariateAnalysisStrategy):
    def analyzer(delf, df: pd.DataFrame, feature1: str, feature2: str):
        """
...
class BivariateAnalyzer:
    ...
    def execute_analysis(self, df: pd.DataFrame, feature1: str, feature2: str):
        ...
        """
        self._strategy.analyzer(df, feature1, feature2)
